...
public class NotaneitorTests {
	...
	static String Geckdriver024 = "C:\\Users\\roloa\\Documents\\SDI\\PL-SDI-Sesión5-material\\geckodriver024win64.exe";
	//En MACOSX (Debe ser la versión 65.0.1 y desactivar las actualizacioens automáticas):
	//static String PathFirefox65 = "C:/Program Files/Mozilla Firefox";
	//static String Geckdriver024 = "C:/Users/roloa/Documents/SDI/PL-SDI-Sesión5-material";
	...
	@Test
	public void PR12() {
		PO_PrivateView.loginAs(driver, "99999990A", "123456", "Notas del usuario");
	...
	@Test
	public void PR14() {
		PO_PrivateView.loginAs(driver, "99999993D" , "123456", "99999993D");
	...
	public void PR15() {
		...
		// Nos vamos a la última página
		elementos.get(3).click();
		// Esperamos a que aparezca la Nueva nota en la ultima pagina. Y Pinchamos en el
		// enlace de borrado de la Nota "Nota Nueva 1" td[contains(text(), 'Nota Nueva
